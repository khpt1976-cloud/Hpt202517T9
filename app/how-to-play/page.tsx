        ...
        <div className="text-center">
          ...
          <Card className="bg-slate-800/50 border-slate-700 max-w-2xl mx-auto">
            ...
            <CardContent className="space-y-6">
              ...
              <p className="text-slate-400 text-lg leading-relaxed">
                Chúng tôi đang xây dựng một hệ thống AI thông minh để tìm kiếm và 
                gợi ý các chiến lược cược tối ưu dựa trên dữ liệu lịch sử và xu hướng thị trường.
              </p>
              ...
              <div className="bg-slate-700/30 rounded-lg p-6 border border-slate-600">
                ...
                <ul className="text-slate-300 space-y-2 text-left">
                  ...
                  <li className="flex items-center">
                    <span className="w-2 h-2 bg-purple-400 rounded-full mr-3"></span>
                    Gợi ý cách chơi theo thời gian thực
                  </li>
                  <li className="flex items-center">
                    <span className="w-2 h-2 bg-purple-400 rounded-full mr-3"></span>
                    Thư viện chiến lược từ cộng đồng
                  </li>
                  <li className="flex items-center">
                    <span className="w-2 h-2 bg-purple-400 rounded-full mr-3"></span>
          ...
          <div className="mt-12">
            ...
            <div className="max-w-md mx-auto bg-slate-700 rounded-full h-3">
              <div className="bg-gradient-to-r from-purple-400 to-pink-500 h-3 rounded-full animate-pulse" style={{width: '25%'}}></div>
            </div>
            <p className="text-slate-500 text-sm mt-2">25% hoàn thành</p>
          </div>
        </div>
      </main>
    </div>
